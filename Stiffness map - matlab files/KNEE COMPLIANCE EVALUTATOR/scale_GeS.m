...
% (output of the compliance pose calculation). Rotations are in degrees,
% translations in mm. The vector contains in order:
...
% Scaled to the current subject under analysis. Rotations are in degrees,
% translations in mm. The vector contains in order:
% [flexion_angle, AA, IE, X, Y, Z]
